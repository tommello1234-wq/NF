...
const empresaSchema = z.object({
  ...
  csc_id_homol: z.string().optional().nullable(),
  csc_token_homol: z.string().optional().nullable(),
  csc_id_prod: z.string().optional().nullable(),
  csc_token_prod: z.string().optional().nullable(),
